...
import { StockReportResponse } from '../../../core/models/report.model';
...
export class StockReportPage implements OnInit {
  ...
  readonly report = signal<StockReportResponse | null>(null);
  ...
  load(): void {
    ...
    this.reportService.getStock(this.startDate(), this.endDate()).subscribe({
      next: (report) => {
